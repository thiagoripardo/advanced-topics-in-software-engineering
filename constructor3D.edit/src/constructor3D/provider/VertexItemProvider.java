...
/**
 * This is the item provider adapter for a {@link constructor3D.Vertex} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VertexItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vertex_posX_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vertex_posX_feature", "_UI_Vertex_type"),
				 Constructor3DPackage.Literals.VERTEX__POS_X,
				 true,
				 false,
				 false,
	...
	protected void addPosYPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vertex_posY_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vertex_posY_feature", "_UI_Vertex_type"),
				 Constructor3DPackage.Literals.VERTEX__POS_Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addPosZPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vertex_posZ_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vertex_posZ_feature", "_UI_Vertex_type"),
				 Constructor3DPackage.Literals.VERTEX__POS_Z,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Constructor3DPackage.Literals.VERTEX__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Vertex_type") + " " + vertex.getId();
	}
