...
/**
 * This is the item provider adapter for a {@link constructor3D.Form} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Form_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Form_id_feature", "_UI_Form_type"),
				 Constructor3DPackage.Literals.FORM__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Constructor3DPackage.Literals.FORM__NAME,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Constructor3DPackage.Literals.FORM__FACE,
				 Constructor3DFactory.eINSTANCE.createFace()));
	}
