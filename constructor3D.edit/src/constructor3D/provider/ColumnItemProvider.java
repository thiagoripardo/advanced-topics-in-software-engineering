...
/**
 * This is the item provider adapter for a {@link constructor3D.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColumnItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Constructor3DPackage.Literals.COLUMN__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Constructor3DPackage.Literals.COLUMN__FORM);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Column_type") + " " + column.getId();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Column.class)) {
			case Constructor3DPackage.COLUMN__ID:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Constructor3DPackage.COLUMN__FORM:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Constructor3DPackage.Literals.COLUMN__FORM,
