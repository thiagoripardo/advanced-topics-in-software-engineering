...
/**
 * This is the item provider adapter for a {@link constructor3D.Canvas} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Canvas_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Canvas_id_feature", "_UI_Canvas_type"),
				 Constructor3DPackage.Literals.CANVAS__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Constructor3DPackage.Literals.CANVAS__NAME,
				 true,
				 false,
				 false,
