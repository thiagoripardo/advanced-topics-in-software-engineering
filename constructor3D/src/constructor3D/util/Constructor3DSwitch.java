 ...
 * @generated
 */
public class Constructor3DSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Constructor3DPackage.CANVAS: {
				Canvas canvas = (Canvas)theEObject;
				T result = caseCanvas(canvas);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Constructor3DPackage.FORM: {
				Form form = (Form)theEObject;
				T result = caseForm(form);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Constructor3DPackage.FACE: {
				Face face = (Face)theEObject;
				T result = caseFace(face);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Constructor3DPackage.VERTEX: {
				Vertex vertex = (Vertex)theEObject;
				T result = caseVertex(vertex);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Constructor3DPackage.CUBE: {
				Cube cube = (Cube)theEObject;
				T result = caseCube(cube);
				if (result == null) result = caseForm(cube);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Constructor3DPackage.TREE: {
				Tree tree = (Tree)theEObject;
				T result = caseTree(tree);
				if (result == null) result = caseForm(tree);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Constructor3DPackage.HOUSE: {
				House house = (House)theEObject;
				T result = caseHouse(house);
				if (result == null) result = caseForm(house);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
